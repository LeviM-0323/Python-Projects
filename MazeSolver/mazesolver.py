...
class MazeApp:
    def __init__(self, master, width, height):
        ...
        self.path_color = PATH_COLOR  # Added path color for clarity
        ...
        self.radio_frame.grid(row=1, column=2, sticky="ew")
        ...
        # Labels
        self.time_label = tk.Label(master, text="Time: -- ms", bg=self.bg_color, fg=self.text_color)
        self.time_label.grid(row=2, column=0, columnspan=3, sticky="ew")

        self.visited_label = tk.Label(master, text="Visited: --", bg=self.bg_color, fg=self.text_color)
        self.visited_label.grid(row=3, column=0, columnspan=3, sticky="ew")
